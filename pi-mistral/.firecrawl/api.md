...
[array](https://docs.mistral.ai/api#operation-chat_completion_v1_chat_completions_post_request_guardrails_guardrailconfig) < [GuardrailConfig](https://docs.mistral.ai/api#operation-chat_completion_v1_chat_completions_post_request_guardrails_guardrailconfig) >\|null
...
Available options to the prompt\_mode argument on the chat completion endpoint.
