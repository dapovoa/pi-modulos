...
![Mistral Small 4 icon](https://docs.mistral.ai/assets/models/Mistral_Small_3.1.svg)

[Compare](https://docs.mistral.ai/models/model-selection-guide?models=mistral-small-4-0-26-03) [Legal](https://legal.mistral.ai/)
...
\\
**Voxtral TTS** v26.03](https://docs.mistral.ai/models/model-cards/voxtral-tts-26-03) [![Leanstral icon](https://docs.mistral.ai/assets/models/Leanstral.svg)\\
\\
