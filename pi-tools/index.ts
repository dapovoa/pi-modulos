...
let step = 0
let activeCommand: "comments" | "clean" | "wiki" | "bug" | "duplication" | "security" | "formatter" | null = null
...
const COMMAND_NAMES: Record<string, "comments" | "clean" | "wiki" | "bug" | "duplication" | "security" | "formatter"> = {
  comments: "comments",
  clean: "clean",
  wiki: "wiki",
  bug: "bug",
